 ...
 * * `score` - Score
 */
export type EvaluationCriteriaEnum =
  (typeof EvaluationCriteriaEnum)[keyof typeof EvaluationCriteriaEnum]
 ...
 * `organizer` - organizer
 */
export type RoleActivationCodeGenerateRoleEnum =
  (typeof RoleActivationCodeGenerateRoleEnum)[keyof typeof RoleActivationCodeGenerateRoleEnum]
...
export type ListAdminUserPointsTransactionsOrdering =
  (typeof ListAdminUserPointsTransactionsOrdering)[keyof typeof ListAdminUserPointsTransactionsOrdering]
...
export type ListMyPointsTransactionsOrdering =
  (typeof ListMyPointsTransactionsOrdering)[keyof typeof ListMyPointsTransactionsOrdering]

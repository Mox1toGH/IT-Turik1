...
GOOGLE_SHEETS_SERVICE_ACCOUNT_INFO = os.getenv('GOOGLE_SHEETS_SERVICE_ACCOUNT_INFO', '')
GOOGLE_SHEETS_DEFAULT_SHARE_WITH = os.getenv('GOOGLE_SHEETS_DEFAULT_SHARE_WITH', '')
